...
namespace Tsltn.Commands
{
    ...
    {
        public static RoutedCommand MoveUp { get; } = new RoutedCommand("MoveUp", typeof(BrowseAllTranslationsCommand), new InputGestureCollection() { new KeyGesture(Key.Up, ModifierKeys.Control) });
