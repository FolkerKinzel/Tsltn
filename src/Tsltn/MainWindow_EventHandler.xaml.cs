...
public sealed partial class MainWindow
{
    ...
    private void Doc_SourceDocumentChanged(object? sender, FileSystemEventArgs e)
    {
        ...
        if (fileName != null)
        {
            _sourceDocumentChangedTask = Task.Run(() => Dispatcher.Invoke(() =>
                                        {
                                            MessageBoxResult result = MessageBox.Show(
                                                this, message, App.ProgramName, MessageBoxButton.YesNo,
    ...
    private void RecentFilesMenu_RecentFileSelected(object? sender, RecentFileSelectedEventArgs e)
    {
        ...
        {
            string errorMessage = string.Format(CultureInfo.InvariantCulture, Res.FileNotFound, Environment.NewLine, e.FileName);
